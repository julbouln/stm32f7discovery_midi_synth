...
#define USB_AUDIO_CONFIG_DESC_SIZ                     127
...
#define AUDIO_OUT_FEATURE_ID                      0x02

#define AUDIO_REQ_CONTROL                          0x01
#define AUDIO_REQ_STREAMING                        0x02


#define MAX_USBD_AUDIO_FREQ                         96000

#define AUDIO_OUT_PACKET                            (uint32_t)(((MAX_USBD_AUDIO_FREQ * 2 * 2) /1000)) 
